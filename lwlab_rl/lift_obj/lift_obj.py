...
from isaac_arena.embodiments.unitree.g1 import UnitreeG1HandEnvRLCfg
from isaac_arena.embodiments.lerobot.lerobot_rl import LERobotEnvRLCfg
...
class G1StateLiftObjRLEnvCfg(UnitreeG1HandEnvRLCfg, BaseLiftObjRLEnvCfg):
    def __post_init__(self):
        super().__post_init__()
        self.fix_object_pose_cfg = {"object": {"pos": (3.93, -0.6, 0.95)}}  # y- near to robot
        # for Lerobot-RL
...
class LerobotStateLiftObjRLEnvCfg(LERobotEnvRLCfg, BaseLiftObjRLEnvCfg):
    def __post_init__(self):
        super().__post_init__()
        self.fix_object_pose_cfg = {"object": {"pos": (3.95, -0.25, 0.934)}}  # y- near to robot
        # for Lerobot-RL
        self.commands.object_pose.body_name = "gripper"
        # for G1-RL
        # self.commands.object_pose.body_name = "right_wrist_yaw_link"
