...
ASSET_PATH = LWLAB_DATA_PATH / "assets" / "piper.usd"
...
# PIPER_HIGH_PD_CFG.actuators["mobile_base_movement"].stiffness = 1e6
# PIPER_HIGH_PD_CFG.actuators["mobile_base_movement"].damping = 1e4
# PIPER_HIGH_PD_CFG.actuators["mobile_base_torso"].stiffness = 1e6
# PIPER_HIGH_PD_CFG.actuators["mobile_base_torso"].damping = 1e4
# PIPER_HIGH_PD_CFG.actuators["mobile_base_rotate"].stiffness = 1e6
# PIPER_HIGH_PD_CFG.actuators["mobile_base_rotate"].damping = 1e4
...
ASSET_PATH = LWLAB_DATA_PATH / "assets" / "double_piper.usd"
...
# DOOUBLE_PIPER_HIGH_PD_CFG.actuators["mobile_base_movement"].stiffness = 1e6
# DOOUBLE_PIPER_HIGH_PD_CFG.actuators["mobile_base_movement"].damping = 1e4
# DOOUBLE_PIPER_HIGH_PD_CFG.actuators["mobile_base_torso"].stiffness = 1e6
# DOOUBLE_PIPER_HIGH_PD_CFG.actuators["mobile_base_torso"].damping = 1e4
# DOOUBLE_PIPER_HIGH_PD_CFG.actuators["mobile_base_rotate"].stiffness = 1e6
# DOOUBLE_PIPER_HIGH_PD_CFG.actuators["mobile_base_rotate"].damping = 1e4
