...
from typing import TYPE_CHECKING, List, Callable, Optional, Dict, Union, TypedDict
import numpy as np
...
from lwlab.core.mdp.helpers.rotation_helper import get_gravity_orientation
from lwlab.core.mdp.helpers.KF import IMUKF
from lwlab.core.mdp.actions.controller import Controller_loco, Controller_squat
...
class LegPositionAction(ActionTerm):
    ...
    def __init__(self, cfg: "LegPositionActionCfg", env: ManagerBasedEnv):
        ...
        loco_config_path = f"lwlab/core/mdp/configs/{cfg.loco_config}"
        self.loco_config = Config(loco_config_path)
        squat_config_path = f"lwlab/core/mdp/configs/{cfg.squat_config}"
