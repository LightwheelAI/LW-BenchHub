...
def _default_urdf_path() -> Tuple[str, list[str]]:
    ...
    # This file: lwlab/utils/pinocchio_ik/piper_ik.py
    cur_dir = os.path.dirname(os.path.abspath(__file__))
    lwlab_dir = os.path.dirname(os.path.dirname(cur_dir))
    # utils/piper_description/urdf/piper_description.urdf
    urdf_dir = os.path.join(lwlab_dir, "utils", "piper_description", "urdf")
    ...
    package_dirs = [os.path.join(lwlab_dir, "utils")]
