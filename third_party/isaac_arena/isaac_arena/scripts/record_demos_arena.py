...
def create_environment_config(
    ...
    try:
        ...
        print("get_arena_env_cfg")
        env_cfg, env_name = get_arena_env_cfg(args_cli)
        print("get_arena_env_cfg done")
...
def create_environment(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg) -> gym.Env:
    ...
    """
    try:
        env = gym.make(env_cfg.env_name, cfg=env_cfg).unwrapped
        return env
    except Exception as e:
    ...
    try:
        if hasattr(env_cfg, "teleop_devices") and args_cli.teleop_device in env_cfg.teleop_devices.devices:
            ...
            if args_cli.teleop_device.lower() == "handtracking":
                        ...
                        "handtracking": OpenXRDeviceCfg(
                            retargeters=[
                                GR1T2RetargeterCfg(
                                    ...
                                    hand_joint_names=env_cfg.actions.pink_ik_cfg.hand_joint_names,
                                ),
                            ],
                            sim_device=env_cfg.sim.device,
                            xr_cfg=env_cfg.xr,
                ...
                teleop_interface = create_teleop_device(args_cli.teleop_device, teleop_devices.devices, callbacks)
